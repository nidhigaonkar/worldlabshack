...
export function MemoryWorldViewer({
  ...
  return (
    <div className="fixed inset-0 bg-reverie-black">
      ...
      {/* Home / Reset view button - left of New Lane */}
      {splatUrl && (
        <button
          onClick={() => resetViewRef.current?.()}
          className="fixed top-6 right-40 z-50 flex items-center justify-center w-10 h-10 rounded-full bg-reverie-surface/80 backdrop-blur-sm border border-reverie-border hover:border-reverie-accent hover:text-white transition-colors"
